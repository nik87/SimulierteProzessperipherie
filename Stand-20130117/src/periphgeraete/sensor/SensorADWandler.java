...
public class SensorADWandler {
    ...
    private JLabel spinnerLabel5 = new JLabel("°C");
    ...
    class ActionListenerForBedienElement implements KeyListener, MouseListener, ChangeListener
    {
	public void keyPressed(KeyEvent e){
		...
		sensorR.printTemp();
		sensorR.wandleAD(Double.valueOf(sensorEingabe.getText().trim()).intValue(),sensorR.getIntSpinnerAufl(),sensorR.getDoubleSpinnerMaxTemp(),sensorR.getIntSpinnerBereichsSpannung());
