...
public class SensorRechnen {
    ...
    /**
     * Stellt den umgerechneten Hex-Wert zur Verfügung
     * @return hex
     */
    ...
    /**
     * Stellt den umgerechneten Binaer-Wert zur Verfügung
     * @return binaer
     */
    ...
    /**
     * Simuliert eine Temperaturerhöhung als Rampenfunktion (linear)
     */
	...
	if (getSolltemperatur() > 0) {
		...
		for (getStartwert(); startwert <= solltemperatur; startwert++) {
		    ...
		    System.out.println("Die Temperatur beträgt: " + startwert
			    + " C");
